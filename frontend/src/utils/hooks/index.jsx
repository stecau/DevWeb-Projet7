...
export function useFetch(url, fetchParamObjet, setInfoFetch) {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            try {
                ...
                const response = await fetch(url, fetchParamObjet);
                ...
                if (!data.error) {
                    ...
                    console.log(`${setInfoFetch.dataMessage}`, data);
                    setData(data);
                } else {
                    alert(`${setInfoFetch.alertMessage}${data.error.message}`);
                }
            } catch (err) {
                // Transmission de l'erreur et changement du status de 'erreur' dans le 'state'
                alert(`${setInfoFetch.erreurMessage}${err} ]`);
                setError(true);
            } finally {
        ...
        fetchData();
    }, [url, fetchParamObjet, setInfoFetch]);
